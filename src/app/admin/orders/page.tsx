...
export default function OrdersPage() {
  ...
  const cols = [
    ...
    { key: 'createdAt', header: 'Created', render: (r: OrderRow) => new Date(r.createdAt).toLocaleString() },
  ];

  return (
    <div className="space-y-4">
      <h1 className="text-xl font-bold">Orders</h1>
      <DataTable<OrderRow> columns={cols as any} rows={rows} empty={loading ? 'Loading…' : 'No orders'} />
